...
contract ReaperAutoCompoundTarot is ReaperBaseStrategy {
     ...
     * {stakingPoolController} - Address to XStakingPoolController, the SpookySwap contract to stake xBoo
     */
    address public constant uniRouter =
        0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    address public constant stakingPoolController =
    ...
    function _leaveSupplyVault(uint256 _poolId) internal {
        ISupplyVault rewardToken = IXStakingPoolController(
            stakingPoolController
        ).poolInfo(_poolId).RewardToken;
    ...
    function _setEstimatedYield(uint256 _poolId) internal {
        IXStakingPoolController.PoolInfo
            memory poolInfo = IXStakingPoolController(stakingPoolController)
                .poolInfo(_poolId);
     ...
     * {xBoo} allowance for the {stakingPoolController} contract,
    ...
    function _givePoolAllowances() internal {
        // for (uint256 index = 0; index < currentlyUsedPools.length; index++) {
        //     IERC20 rewardToken = IXStakingPoolController(stakingPoolController)
    ...
    function _removePoolAllowances() internal {
        // for (uint256 index = 0; index < currentlyUsedPools.length; index++) {
        //     uint8 poolId = currentlyUsedPools[index];
        //     IXStakingPoolController(stakingPoolController).poolInfo(poolId).RewardToken.safeApprove(
        //         uniRouter,
        //         0
        //     );
        // }
